...
import 'package:course_app/quiz/twilight/widgets/questions_summary.dart';
...
class ResultScreen extends StatelessWidget {
  ...
  List<Map<String, Object>> get getSummaryData {
    ...
    for (var i = 0; i < chosenAnswers.length; i++) {
      summary.add({
        'questionIndex': i,
        'question': questionsTwilight[i].question,
        'correctAnswer': questionsTwilight[i].answers[0],
  ...
  Widget build(BuildContext context) {
    ...
    final numTotalQuestions = questionsTwilight.length;
